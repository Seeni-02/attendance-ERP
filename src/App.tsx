          ...
          <div className="max-w-7xl mx-auto px-4 py-6 space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
              <div className="p-4 border-b bg-orange-50 flex items-center justify-between">
                <h3 className="font-semibold text-orange-800">🏖️ Holidays in Supabase ({currentClassData.holidayDates?.length || 0})</h3>
              </div>
              <div className="p-4">
                    ...
                    <table className="w-full text-sm">
                      <thead>
                        <tr className="bg-orange-50/50 border-b border-orange-100">
                          ...
                          <th className="px-3 py-2 text-right text-xs font-semibold text-orange-800">Action</th>
                        </tr>
                      </thead>
                      <tbody>
